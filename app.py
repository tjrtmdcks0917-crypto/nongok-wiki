...
def index():
    ...
    return render_template(
        ...
        facility_groups=[
            {"label": "교실·교과교실", "items": [
                {"title": "학교 시설/교실 및 교과교실", "label": "교실 및 교과교실"},
            ]},
            {"label": "과학·창의활동시설", "items": [
                {"title": "학교 시설/과학·창의활동시설", "label": "과학·창의활동시설"},
            ]},
            {"label": "예체능·체육시설", "items": [
                {"title": "학교 시설/예체능·체육시설", "label": "예체능·체육시설"},
            ]},
            {"label": "학생지원시설", "items": [
                {"title": "학교 시설/학생지원시설", "label": "학생지원시설"},
            ]},
            {"label": "운영·행정시설", "items": [
                {"title": "학교 시설/운영·행정시설", "label": "운영·행정시설"},
            ]},
            {"label": "야외시설", "items": [
                {"title": "학교 시설/야외시설", "label": "야외시설"},
            ]},
        ],
